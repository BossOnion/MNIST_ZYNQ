	...
	)
{
	...
	{
#pragma HLS LOOP_TRIPCOUNT min=6 max=120 avg=65
		for(int i=0;i<Hout;i++) 
		{
#pragma HLS LOOP_TRIPCOUNT min=1 max=28 avg=14
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=28 avg=14
				...
				{
#pragma HLS LOOP_TRIPCOUNT min=1 max=7 avg=3
...
#pragma HLS LOOP_TRIPCOUNT min=1 max=120 avg=50
